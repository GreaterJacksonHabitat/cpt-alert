 ...
 * @return array
 */
function gjh_get_alerts_default_args() {
	 ...
	 * @since 1.0.0
	 */
	return apply_filters( 'gjh_get_alerts_default_args', $args );
 ...
 * @return array
 */
function gjh_alert_default_args() {
	 ...
	 * @since 1.0.0
	 */
	return apply_filters( 'gjh_alert_default_args', array(
		'post_ID'          => 0,
		'content'          => '',
		'color'            => 'default',
		'type'             => 'inset-banner',
 ...
 * @return array
 */
function gjh_get_alerts( $args = array() ) {

	static $network_alerts;

	$args = wp_parse_args( $args, gjh_get_alerts_default_args() );

	/*

	$network_alerts = ! $network_alerts ? get_network_option( null, 'gjh_alerts', false ) : $network_alerts;
	...
	*/
	 ...
	 * @since 1.0.0
	 */
	$alerts = apply_filters( 'gjh_alerts_show_alerts', $alerts );
	...
	if ( $alerts ) {
		foreach ( $alerts as $i => $alert ) {
			...
			if ( isset( $alert['user_interaction'] ) && 
				...
				$alert['button_text'] = __( 'Close', 'gjh-cpt-alert' );
			}

			if ( isset( $alert['user_interaction'] ) && 
					   $alert['user_interaction'] == 'call_to_action' && 
					   empty( $alert['button_text'] ) ) {
				$alert['button_text'] = __( 'Learn More', 'gjh-cpt-alert' );
			}
			...
			$alert = wp_parse_args( $alert, gjh_alert_default_args() );
...
function gjh_show_top_alerts( $args = array() ) {
	...
	?>
	<div class="gjh-alerts-container" <?php echo $data; ?>>
		<div class="gjh-alert pop-up gjh-alert-dummy" style="display: none;">
			<div class="gjh-alert-container">
				
				<div class="gjh-alert-content">
					
					<div class="gjh-alert-image show-for-medium"></div>
					
					<div class="gjh-alert-image show-for-small-only"></div>
					
					<div class="row small-collapse">
					
						<div class="small-1 columns small-icon-container">
							<span class="gjh-alert-icon show-for-small-only" aria-hidden="true"></span>
						</div>

						<div class="text-content small-9 small-pull-2 medium-pull-0 medium-12 columns">

							<div class="gjh-alert-text"></div>

							<div class="show-for-small-only">
								<a href="#" class="gjh-alert-button"></a>
							</div>
					...
					<a href="#" class="gjh-alert-button show-for-medium"></a>
 ...
 * @param array $args
 */
function gjh_show_inset_alerts( $args = array() ) {
	...
	?>
	<div class="gjh-alerts-container" <?php echo $data; ?>>
		<div class="gjh-alert inset-banner gjh-alert-dummy" style="display: none;">
			<div class="gjh-alert-container">
				<div class="gjh-alert-content">

					<div class="gjh-alert-text-container">
						<span class="gjh-alert-icon" aria-hidden="true"></span>
						<span class="gjh-alert-text"></span>
					</div>

					<div class="gjh-alert-button-container">
						<a href="#" class="gjh-alert-button"></a>
					</div>
